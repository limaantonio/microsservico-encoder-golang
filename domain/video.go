...
type Video struct {
	...
	CreatedAt  time.Time `json:"-" valid:"-"`                           // "-" means that this field will not be validated
	Jobs       []*Job    `json:"-" valid:"-" gorm:"ForeignKey:VideoID"` // "-" means that this field will not be validated
}
